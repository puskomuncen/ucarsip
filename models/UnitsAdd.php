...
class UnitsAdd extends Units
{
    ...
    // Page object name
    public string $PageObjName = "UnitsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "unitsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "unitsview") {
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        $val = $this->hasFormValue("unit_id") ? $this->getFormValue("unit_id") : $this->getFormValue("x_unit_id");
    }
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($this->kode_unit->CurrentValue != "") { // Check field with unique index
            $filter = "(`kode_unit` = '" . AdjustSql($this->kode_unit->CurrentValue) . "')";
    ...
    protected function getAddRow(): array
    {
        ...
        // nama_unit
        $this->nama_unit->setDbValueDef($newRow, $this->nama_unit->CurrentValue, false);
