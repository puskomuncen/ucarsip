 ...
 * Page class
 */
class UnitsDelete extends Units
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "UnitsDelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("unitslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("unitslist"); // Return to list
                return;
            }
        }
