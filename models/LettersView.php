 ...
 * Page class
 */
class LettersView extends Letters
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "LettersView";
    ...
    // CSS class/style
    public string $CurrentPageName = "lettersview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("letter_id") ?? Route("letter_id")) !== null) {
            $this->RecKey["letter_id"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("letter_id") ?? Route("letter_id")) !== null) {
            ...
            $this->RecKey["letter_id"] = $this->letter_id->QueryStringValue;
        } elseif (Post("letter_id") !== null) {
            $this->letter_id->setFormValue(Post("letter_id"));
            $this->RecKey["letter_id"] = $this->letter_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->letter_id->setQueryStringValue($keyValue);
            $this->RecKey["letter_id"] = $this->letter_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "letterslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("letterslist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->letter_id->CurrentValue, $this->CurrentRow['letter_id'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "letterslist"; // No matching record, return to list
                    } else {
