...
class UnitsView extends Units
{
    ...
    // Page object name
    public string $PageObjName = "UnitsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "unitsview";
...
// Is modal
        ...
        if (($keyValue = Get("unit_id") ?? Route("unit_id")) !== null) {
            ...
            $this->RecKey["unit_id"] = $this->unit_id->QueryStringValue;
        } elseif (Post("unit_id") !== null) {
            $this->unit_id->setFormValue(Post("unit_id"));
            $this->RecKey["unit_id"] = $this->unit_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->unit_id->setQueryStringValue($keyValue);
            $this->RecKey["unit_id"] = $this->unit_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "unitslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("unitslist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->unit_id->CurrentValue, $this->CurrentRow['unit_id'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "unitslist"; // No matching record, return to list
                    } else {
