 ...
 * Page class
 */
class TracksDelete extends Tracks
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "TracksDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "tracksdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("trackslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("trackslist"); // Return to list
                return;
            }
        }
