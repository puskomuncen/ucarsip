 ...
 * Page class
 */
class LettersList extends Letters
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "LettersList";
    ...
    public string $FormName = "fletterslist";

    // CSS class/style
    public string $CurrentPageName = "letterslist";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        // Initialize URLs
        $this->AddUrl = "lettersadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "lettersdelete";
        $this->MultiUpdateUrl = "lettersupdate";
...
// Is modal
		...
		if (ReadCookie('letters_searchpanel') == 'notactive' || ReadCookie('letters_searchpanel') == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (ReadCookie('letters_searchpanel') == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fletterssrch");
        }
        $filterList = Concat($filterList, $this->letter_id->AdvancedSearch->toJson(), ","); // Field letter_id
        $filterList = Concat($filterList, $this->nomor_surat->AdvancedSearch->toJson(), ","); // Field nomor_surat
        $filterList = Concat($filterList, $this->perihal->AdvancedSearch->toJson(), ","); // Field perihal
        $filterList = Concat($filterList, $this->tanggal_surat->AdvancedSearch->toJson(), ","); // Field tanggal_surat
        ...
        $filterList = Concat($filterList, $this->klasifikasi->AdvancedSearch->toJson(), ","); // Field klasifikasi
        $filterList = Concat($filterList, $this->pengirim->AdvancedSearch->toJson(), ","); // Field pengirim
        $filterList = Concat($filterList, $this->penerima_unit_id->AdvancedSearch->toJson(), ","); // Field penerima_unit_id
        $filterList = Concat($filterList, $this->file_url->AdvancedSearch->toJson(), ","); // Field file_url
    ...
    protected function processFilterList(): bool
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fletterssrch", $filters);
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field letter_id
        $this->letter_id->AdvancedSearch->SearchValue = $filter["x_letter_id"] ?? "";
        $this->letter_id->AdvancedSearch->SearchOperator = $filter["z_letter_id"] ?? "";
        $this->letter_id->AdvancedSearch->SearchCondition = $filter["v_letter_id"] ?? "";
        $this->letter_id->AdvancedSearch->SearchValue2 = $filter["y_letter_id"] ?? "";
        $this->letter_id->AdvancedSearch->SearchOperator2 = $filter["w_letter_id"] ?? "";
        $this->letter_id->AdvancedSearch->save();
        ...
        // Field perihal
        $this->perihal->AdvancedSearch->SearchValue = $filter["x_perihal"] ?? "";
        $this->perihal->AdvancedSearch->SearchOperator = $filter["z_perihal"] ?? "";
        $this->perihal->AdvancedSearch->SearchCondition = $filter["v_perihal"] ?? "";
        $this->perihal->AdvancedSearch->SearchValue2 = $filter["y_perihal"] ?? "";
        $this->perihal->AdvancedSearch->SearchOperator2 = $filter["w_perihal"] ?? "";
        $this->perihal->AdvancedSearch->save();

        // Field tanggal_surat
        $this->tanggal_surat->AdvancedSearch->SearchValue = $filter["x_tanggal_surat"] ?? "";
        $this->tanggal_surat->AdvancedSearch->SearchOperator = $filter["z_tanggal_surat"] ?? "";
        $this->tanggal_surat->AdvancedSearch->SearchCondition = $filter["v_tanggal_surat"] ?? "";
        $this->tanggal_surat->AdvancedSearch->SearchValue2 = $filter["y_tanggal_surat"] ?? "";
        $this->tanggal_surat->AdvancedSearch->SearchOperator2 = $filter["w_tanggal_surat"] ?? "";
        $this->tanggal_surat->AdvancedSearch->save();
        ...
        // Field klasifikasi
        $this->klasifikasi->AdvancedSearch->SearchValue = $filter["x_klasifikasi"] ?? "";
        $this->klasifikasi->AdvancedSearch->SearchOperator = $filter["z_klasifikasi"] ?? "";
        $this->klasifikasi->AdvancedSearch->SearchCondition = $filter["v_klasifikasi"] ?? "";
        $this->klasifikasi->AdvancedSearch->SearchValue2 = $filter["y_klasifikasi"] ?? "";
        $this->klasifikasi->AdvancedSearch->SearchOperator2 = $filter["w_klasifikasi"] ?? "";
        $this->klasifikasi->AdvancedSearch->save();

        // Field pengirim
        $this->pengirim->AdvancedSearch->SearchValue = $filter["x_pengirim"] ?? "";
        $this->pengirim->AdvancedSearch->SearchOperator = $filter["z_pengirim"] ?? "";
        $this->pengirim->AdvancedSearch->SearchCondition = $filter["v_pengirim"] ?? "";
        $this->pengirim->AdvancedSearch->SearchValue2 = $filter["y_pengirim"] ?? "";
        $this->pengirim->AdvancedSearch->SearchOperator2 = $filter["w_pengirim"] ?? "";
        $this->pengirim->AdvancedSearch->save();

        // Field penerima_unit_id
        $this->penerima_unit_id->AdvancedSearch->SearchValue = $filter["x_penerima_unit_id"] ?? "";
        $this->penerima_unit_id->AdvancedSearch->SearchOperator = $filter["z_penerima_unit_id"] ?? "";
        $this->penerima_unit_id->AdvancedSearch->SearchCondition = $filter["v_penerima_unit_id"] ?? "";
        $this->penerima_unit_id->AdvancedSearch->SearchValue2 = $filter["y_penerima_unit_id"] ?? "";
        $this->penerima_unit_id->AdvancedSearch->SearchOperator2 = $filter["w_penerima_unit_id"] ?? "";
        $this->penerima_unit_id->AdvancedSearch->save();

        // Field file_url
        $this->file_url->AdvancedSearch->SearchValue = $filter["x_file_url"] ?? "";
        $this->file_url->AdvancedSearch->SearchOperator = $filter["z_file_url"] ?? "";
        $this->file_url->AdvancedSearch->SearchCondition = $filter["v_file_url"] ?? "";
        $this->file_url->AdvancedSearch->SearchValue2 = $filter["y_file_url"] ?? "";
        $this->file_url->AdvancedSearch->SearchOperator2 = $filter["w_file_url"] ?? "";
        $this->file_url->AdvancedSearch->save();
    ...
    public function basicSearchWhere(bool $default = false): string
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->nomor_surat;
        $searchFlds[] = &$this->perihal;
        $searchFlds[] = &$this->pengirim;
        $searchFlds[] = &$this->file_url;
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->letter_id); // letter_id
            $this->updateSort($this->nomor_surat); // nomor_surat
            $this->updateSort($this->perihal); // perihal
            $this->updateSort($this->tanggal_surat); // tanggal_surat
            $this->updateSort($this->tanggal_terima); // tanggal_terima
            $this->updateSort($this->jenis); // jenis
            $this->updateSort($this->klasifikasi); // klasifikasi
            $this->updateSort($this->pengirim); // pengirim
            $this->updateSort($this->penerima_unit_id); // penerima_unit_id
            $this->updateSort($this->file_url); // file_url
    ...
    protected function resetCmd(): void
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->letter_id->setSort("");
                $this->nomor_surat->setSort("");
                $this->perihal->setSort("");
                $this->tanggal_surat->setSort("");
                $this->tanggal_terima->setSort("");
                $this->jenis->setSort("");
                $this->klasifikasi->setSort("");
                $this->pengirim->setSort("");
                $this->penerima_unit_id->setSort("");
    ...
    public function renderListOptions(): void
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($this->security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"letters\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $this->language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($this->security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"letters\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $this->language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($this->security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"letters\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("CopyLink") . "</a>";
                } else {
            ...
            foreach ($this->ListActions as $listAction) { // ActionType::SINGLE
                ...
                if ($listAction->Select == ActionType::SINGLE && $listAction->getVisible()) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                        "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fletterslist\" data-key=\"" . $this->keyToJson(true) .
                    ...
                    if ($body == "") { // Setup first button
                        $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                            "\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fletterslist\" data-key=\"" . $this->keyToJson(true) .
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->letter_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"letters\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "letter_id");
            $this->createColumnOption($option, "nomor_surat");
            $this->createColumnOption($option, "perihal");
            $this->createColumnOption($option, "tanggal_surat");
            $this->createColumnOption($option, "tanggal_terima");
            $this->createColumnOption($option, "jenis");
            $this->createColumnOption($option, "klasifikasi");
            $this->createColumnOption($option, "pengirim");
            $this->createColumnOption($option, "penerima_unit_id");
            $this->createColumnOption($option, "file_url");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fletterssrch\" data-ew-action=\"none\">" . $this->language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fletterssrch\" data-ew-action=\"none\">" . $this->language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions(): void
    {
        ...
        foreach ($this->ListActions as $listAction) { // ActionType::MULTIPLE
            if ($listAction->Select == ActionType::MULTIPLE && $listAction->getVisible()) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fletterslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
                $item->Visible = true;
            }
        }
    ...
    public function setupRow(): void
    {
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_letters", "data-rowtype" => RowType::ADD]);
...
// Load basic search values
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->penerima_unit_id->TooltipValue = "";
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (ReadCookie('letters_searchpanel') == 'notactive' || ReadCookie('letters_searchpanel') == "") {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fletterssrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		} elseif (ReadCookie('letters_searchpanel') == 'active') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fletterssrch\" aria-pressed=\"true\">" . $this->language->phrase("SearchLink") . "</a>";
		} else {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fletterssrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
