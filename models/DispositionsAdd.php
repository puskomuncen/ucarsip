 ...
 * Page class
 */
class DispositionsAdd extends Dispositions
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "DispositionsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "dispositionsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "dispositionsview") {
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'disposition_id' first before field var 'x_disposition_id'
        $val = $this->hasFormValue("disposition_id") ? $this->getFormValue("disposition_id") : $this->getFormValue("x_disposition_id");
    }
    ...
    protected function getAddRow(): array
    {
        ...
        // dari_unit_id
        $this->dari_unit_id->setDbValueDef($newRow, $this->dari_unit_id->CurrentValue, false);

        // ke_unit_id
        $this->ke_unit_id->setDbValueDef($newRow, $this->ke_unit_id->CurrentValue, false);
