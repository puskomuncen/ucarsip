...
$sideMenu->addMenuItem(42, "mi_letters", $Language->menuPhrase("42", "MenuText"), "letterslist", 39, substr("mi_letters", strpos("mi_letters", "mi_") + 3), AllowListMenu('{CB54660F-9AFA-48FD-B6BB-4648712A04D7}letters'), false, false, "fa-envelope-o", "", false, true);
$sideMenu->addMenuItem(41, "mi_dispositions", $Language->menuPhrase("41", "MenuText"), "dispositionslist", 39, substr("mi_dispositions", strpos("mi_dispositions", "mi_") + 3), AllowListMenu('{CB54660F-9AFA-48FD-B6BB-4648712A04D7}dispositions'), false, false, "fa-pencil-square-o", "", false, true);
