...
(function (global, factory) {
  ...
  var Default$5 = {
    ...
    enableRemember: true, // changed from false to true by Masino Sinaga, October 13, 2024
  ...
  var PushMenu = /*#__PURE__*/function () {
    ...
    _proto.expand = function expand() {
      ...
      if (this._options.enableRemember) {
		...
		// Begin of modification by Masino Sinaga, October 13, 2024
		var expires = new Date(new Date().getTime() + 525600 * 60 * 1000); // expire in 525600 
		Cookies.set('aside_toggle_state', "expanded", { path: '/', expires: expires });
		// End of modification by Masino Sinaga, October 13, 2024
      }
    ...
    _proto.collapse = function collapse() {
      ...
      if (this._options.enableRemember) {
		...
		// Begin of modification by Masino Sinaga, October 13, 2024
		var expires = new Date(new Date().getTime() + 525600 * 60 * 1000); // expire in 525600 
		Cookies.set('aside_toggle_state', "collapsed", { path: '/', expires: expires });
		// End of modification by Masino Sinaga, October 13, 2024
      }
